...
inline void decodePacket(PacketBuffer const &data, uint32_t const timestamp_us,
...
xv11::Lidar::Lidar(DataReader read_byte, PWMWriter write_pwm,
                   TimestampGetter micros, float motor_rpm)
    : m_read_byte(read_byte), m_write_pwm(write_pwm), m_micros(micros),
      m_packet_bytes(0), motor_rpm(motor_rpm) {}
