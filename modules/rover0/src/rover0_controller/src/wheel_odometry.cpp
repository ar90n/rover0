...
namespace {
    ...
    DeltaPosition calc_global_delta_position(
      DeltaPosition local_delta_pos,
      double heading,
      double delta_heading
    )
...
bool rover0_controller::WheelOdometry::update(
    ...
    rover0_controller::mecanum_kinematics::Twist const twist = mecanum_kinematics_.forward(
        rover0_controller::mecanum_kinematics::WheelAngularVelocity{
...
double rover0_controller::WheelOdometry::getX() const { return x_; }
double rover0_controller::WheelOdometry::getY() const { return y_; }
double rover0_controller::WheelOdometry::getHeading() const { return heading_; }
double rover0_controller::WheelOdometry::getLinearX() const { return linear_x_accumulator_.getRollingMean(); }
double rover0_controller::WheelOdometry::getLinearY() const { return linear_y_accumulator_.getRollingMean(); }
double rover0_controller::WheelOdometry::getAngular() const { return angular_z_accumulator_.getRollingMean(); }
