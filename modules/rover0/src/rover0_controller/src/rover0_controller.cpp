...
rover0_controller::Rover0Controller::update(const rclcpp::Time& time, const rclcpp::Duration& period)
{
  if (has_new_msg_)
  {
  ...
  auto const wheel_angular_velocity =
    mecanum_kinematics_->inverse(rover0_controller::mecanum_kinematics::Twist{ cmd_vel_twist_->linear.x,
  ...
  (void)command_interface_map_.at(config.front_left_wheel_joint_name)
    .get()
    .set_value(wheel_angular_velocity.front_left);
  (void)command_interface_map_.at(config.front_right_wheel_joint_name)
    .get()
    .set_value(wheel_angular_velocity.front_right);
  (void)command_interface_map_.at(config.rear_left_wheel_joint_name)
    .get()
    .set_value(wheel_angular_velocity.rear_left);
  (void)command_interface_map_.at(config.rear_right_wheel_joint_name)
    .get()
    .set_value(wheel_angular_velocity.rear_right);
...
{
  config.front_left_wheel_joint_name =
    auto_declare<std::string>("front_left_wheel_joint_name", config.front_left_wheel_joint_name);
  config.front_right_wheel_joint_name =
    auto_declare<std::string>("front_right_wheel_joint_name", config.front_right_wheel_joint_name);
  config.rear_left_wheel_joint_name =
    auto_declare<std::string>("rear_left_wheel_joint_name", config.rear_left_wheel_joint_name);
  config.rear_right_wheel_joint_name =
    auto_declare<std::string>("rear_right_wheel_joint_name", config.rear_right_wheel_joint_name);
...
rover0_controller::Rover0Controller::on_configure(const rclcpp_lifecycle::State&)
{
  ...
  auto odometry_publisher_ =
    get_node()->create_publisher<nav_msgs::msg::Odometry>(config.odom_topic, rclcpp::SystemDefaultsQoS());
  rt_odometry_pub_ =
...
controller_interface::CallbackReturn
rover0_controller::Rover0Controller::on_activate(const rclcpp_lifecycle::State&)
{
...
controller_interface::CallbackReturn
rover0_controller::Rover0Controller::on_deactivate(const rclcpp_lifecycle::State&)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn
rover0_controller::Rover0Controller::on_cleanup(const rclcpp_lifecycle::State&)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn
rover0_controller::Rover0Controller::on_error(const rclcpp_lifecycle::State&)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn
rover0_controller::Rover0Controller::on_shutdown(const rclcpp_lifecycle::State&)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

controller_interface::InterfaceConfiguration
rover0_controller::Rover0Controller::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
rover0_controller::Rover0Controller::state_interface_configuration() const
{
